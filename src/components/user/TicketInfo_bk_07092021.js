       ...
       <div className="card mb-0">
                      ...
                      <div className="row">
                        <div className="col-md-12 d-flex">
                          <div className="card profile-box flex-fill">
                            <div className="card-body">
                              <h3 className="card-title">Pending Update<a href="#" className="edit-icon" data-toggle="modal" data-target="#proposal_internal_order"><i className="fa fa-pencil"></i></a></h3>
                                <ul className="personal-info">
                                <li>
                                  <div className="title">Assign To</div>
                                  <div className="text">XYZ</div>
                                </li>
                                <li>
                 ...
                 <tr>
                        ...
                        <div className="col-md-12 d-flex">
                          <div className="card profile-box flex-fill">
                            <div className="card-body">
                                <h3 className="card-title">Assign Update<a href="#" className="edit-icon" data-toggle="modal" data-target="#proposal_order_assign"><i className="fa fa-pencil"></i></a></h3>
...
26700
                    ...
                    <td className="si"></td>
                                 ...
                                 <li>
                                  <div className="title">Requirement Details</div>
                                  <div className="text">Requirement Details</div>
                                </li>
