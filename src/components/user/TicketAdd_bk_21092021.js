  ...
  OnchangeDefTransportationQuantity=(e)=>{
    ...
    $('.transportationCost').each(function(index, element){
      if($(element).val()!="")
      {
        ...
        console.log("parseFloat Cost quan"+index+"  "+parseFloat($(element).val()));
      }
    });
    console.log("Shree quan");
    console.log(sum_cost);
...
/>
  ...
  {this.state.teamMoreAddData.map((itemteamMoreAddData, tmidx) => (
    ...
    <td className="assign-left">
    <select className="form-control select staff_id" onChange={this.onChangeStaff}>
    <option value="">Select Staff</option> 
    
    </select>
    </td>
    <td className="assign-left">
      <input class="form-control reporting_to"  type="text" />
    </td>
    <td className="assign-left">
