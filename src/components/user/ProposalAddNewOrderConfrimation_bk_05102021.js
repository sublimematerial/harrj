  ...
  import { TicketAdd, TicketAddInspection, TicketAddTeam, TicketAddSupportingDoc, TicketAddMaintenance, TicketAddStatus } from "./../../actions/adminTicket";
 ...
 handleTaxesDuesRateChange=(e, tidx)=>{
    var array = this.state.taxesduesMoreAddData.slice();
    array[tidx].taxesduesRate = e.target.value;

    var rate = $("#taxesduesRate"+tidx).val();
    var quntity = $("#taxesduesQuntity"+tidx).val();
    var sum = parseFloat(rate) * parseFloat(quntity);
    array[tidx].taxesduesCost = sum;
  ...
  handleTaxesDuesQuntityChange=(e, tidx)=>{
    var array = this.state.taxesduesMoreAddData.slice();

    array[tidx].taxesduesQuntity = e.target.value;
  ...
  handleTaxesDuesCostChange=(e, tidx)=>{
    var array = this.state.taxesduesMoreAddData.slice();
    array[tidx].taxesduesCost = e.target.value;
    this.setState({ taxesduesMoreAddData: array });
  }
  ...
  render() {
    ...
    return (
      ...
      <h3 className="page-title">Order Confrimation</h3>
      <ul className="breadcrumb">
      <li className="breadcrumb-item"><a href="index.html">Dashboard</a></li>
      <li className="breadcrumb-item active">Order Confrimation</li>
      </ul>
      </div>
      <div class="col-auto float-right ml-auto">
        <Link to={"/tickets/list"} class="btn add-btn">List Order Confrimation</Link>
      </div>
      </div>
      </div>
      ...
      <li className="nav-item"><a href="#tab_team" id="tab_team_link" data-toggle="tab" className="nav-link"> Assign Team</a></li>
     ...
     <input type="text" className="form-control" id="location" name="location" value="ABC Client" onChange={this.onChangeLocaton} readonly required />
        </div>
        </div>
        ...
        <input type="text" className="form-control" id="location" name="location" value="Mumbai" onChange={this.onChangeLocaton} readonly required />
        </div>
        </div>
...
/>
  ...
  <div className="modal-header">
  <h4 className="modal-title">Cost of Lift</h4>
  </div>
  <div className="modal-body">
