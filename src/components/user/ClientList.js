...
class Dashboard extends Component {
  ...
  ListClientFun=()=>{
console.log("user ListClient func cald")
                              ...
                              <td className="text-right">
                                <div className="dropdown dropdown-action">
                                  ...
                                  <div className="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a className="dropdown-item" onClick={() => this.handleDeleteConfirm(itemClientList.client_id)}><i className="fa fa-trash-o m-r-5"></i> Delete</a>
                                  </div>
                                </div>
                              </td>
                            </tr>
