  ...
  import { TicketAdd, TicketAddInspection, TicketAddTeam, TicketAddSupportingDoc, TicketAddMaintenance, TicketAddStatus, TicketBasicInfo } from "./../../actions/adminTicket";
  ...
  class Dashboard extends Component {
    constructor(props) {
      ...
      this.state = {
        ...
        tab_team_link_block: 'none',
        tab_maintenance_link_block: 'none',
        tab_draw_link_block: 'none',
        tab_cost_link_block: 'none',
        tab_complete_link_block: 'none',
...
*/
  ...
  render() {
    ...
    return (
      ...
      <li className="nav-item"><a href="#tab_basic" id="tab_basic_link" data-toggle="tab" className="nav-link active" style={{pointerEvents: this.state.tab_basic_link_block}} >Create Ticket</a></li>
      <li className="nav-item"><a href="#tab_team" id="tab_team_link" data-toggle="tab" className="nav-link" style={{pointerEvents: this.state.tab_team_link_block}} > Assign Team</a></li>
      <li className="nav-item"><a href="#tab_maintenance" id="tab_maintenance_link" data-toggle="tab" className="nav-link" style={{pointerEvents: this.state.tab_maintenance_link_block}} > Implementation</a></li>
      <li className="nav-item"><a href="#tab_draw" id="tab_draw_link" data-toggle="tab" className="nav-link" style={{pointerEvents: this.state.tab_draw_link_block}} >Supporting Documents</a></li>
      <li className="nav-item"><a href="#tab_cost" id="tab_cost_link" data-toggle="tab" className="nav-link" style={{pointerEvents: this.state.tab_cost_link_block}} >Site Inspection</a></li>
      <li className="nav-item"><a href="#tab_complete" id="tab_complete_link" data-toggle="tab" className="nav-link" style={{pointerEvents: this.state.tab_complete_link_block}} >Status</a></li>
      </ul>
      </div>
      </div>
      </div>
...
/>
  ...
  {this.state.materialMoreAddData.map((itemmaterialMoreAddData, vmidx) => (
    ...
    <tr>
    <td className="assign-left">
    <select className="form-control select vendor_id"  onChange={e => this.onChangeVendor(e, vmidx)}>
    <option value="">Select Vendor</option>
    {this.state.listVendorData && typeof this.state.listVendorData !=="undefined" & this.state.listVendorData.length > 0 && this.state.listVendorData.map((itemVendorList,b) => (
    <option value={itemVendorList.vendor_id}>{itemVendorList.name}</option>
    ))}
