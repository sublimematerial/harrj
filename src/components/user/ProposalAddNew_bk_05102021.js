  ...
  render() {
    ...
    return (
      ...
      <div class="col-auto float-right ml-auto">
        <Link to={"/proposals/list"} class="btn add-btn">List Proposal</Link>
      </div>
      </div>
      </div>
      ...
      <li className="nav-item"><a href="#tab_basic" id="tab_basic_link" data-toggle="tab" className="nav-link active">Create Proposal</a></li>
      ...
      <div class="col-md-6">
        ...
        <input type="text" className="form-control" id="ticket_datetime" name="ticket_datetime" value={this.state.ticket_datetime} onChange={this.onChangeTicketDate} required />
        </div>
        </div>
...
<div className="card-body">
   ...
   <div class="col-md-6">
            ...
            {this.state.uploadFileMoreAddData.map((itemuploadFileMoreAddData, uidx) => (
              ...
              <div class="col-md-6">
            <div className="form-group">
            <h5>Upload Lift Specification Structure Documents:</h5> </div>
            </div>
