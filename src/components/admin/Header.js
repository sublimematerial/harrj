...
class SideBar extends Component {
  ...
  onChangeLanguage=(e)=>{
    ...
    this.setState({ selectedLang: e.target.name});
    ...
    return (
      <React.Fragment>
        <div className="header">
          ...
          <div className="header-left" style={{ paddingLeft:"0px", paddingRight:"145px"}}>
           {/* <a href="index.html" className="logo"><img src={logoImg} width="-1" height="40" alt="" /></a> */}
         
         <center><a href="javascript:void(0)" className="logo"><img src={logoImg}  width="148%" height="60px" style={{ height: "60px",width: "148%"}} alt="" /></a></center>
           </div>
        ...
        <ul className="nav user-menu">
          ...
          <li className="nav-item dropdown has-arrow flag-nav">
            <a className="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
              <img src={flagImgUS} alt="" height="20" /> <span>{this.state.selectedLang}</span>
            </a>
            <div className="dropdown-menu dropdown-menu-right">
              <a href="javascript:void(0);" className="dropdown-item" name="English" onClick={this.onChangeLanguage}>
                <img src={flagImgUS} alt="" height="16" /> English
              </a>
              <a href="javascript:void(0);" className="dropdown-item" name ="French" onClick={this.onChangeLanguage}>
                <img src={flagImgFR} alt="" height="16" /> French
              </a>
              <a href="javascript:void(0);" className="dropdown-item" name ="Spanish" onClick={this.onChangeLanguage}>
                <img src={flagImgES} alt="" height="16" /> Spanish
              </a>
              <a href="javascript:void(0);" className="dropdown-item" name="German" onClick={this.onChangeLanguage}>
