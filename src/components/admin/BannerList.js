...
class Dashboard extends Component {
  ...
  handleSubmit=(e)=>{
    ...
    if (this.checkBtn.context._errors.length === 0) {
      dispatch(BannerAdd(this.state.banner_img))
        .then((response) => {
            if(response.success || response.success ==="true" || response.success ===true){
              toast.success(response.message, {position: "bottom-right", autoClose: 5000, hideProgressBar: false, closeonClick: true, pauseOnHover: true, draggable: true, progress: undefined, });
              this.ListBannerFun();
  ...
  handleUpdateSubmit=(e)=>{
    ...
    if (this.checkUpdateBtn.context._errors.length === 0) {
      dispatch(BannerUpdate(this.state.banner_id, this.state.edit_banner_img))
        .then((response) => {
            if(response.success || response.success ==="true" || response.success ===true){
              toast.success(response.message, {position: "bottom-right", autoClose: 5000, hideProgressBar: false, closeonClick: true, pauseOnHover: true, draggable: true, progress: undefined, });
              this.ListBannerFun();
              this.setState({ banner_id: 0, edit_banner_img: '' });
        ...
        <div className="main-wrapper">
                              ...
                              <td className="text-right">
                                <div className="dropdown dropdown-action">
                                  ...
                                  <div className="dropdown-menu dropdown-menu-right">
                                    <a className="dropdown-item" onClick={() => this.InfoBannerFun(itemCategoryList.banner_id)}><i className="fa fa-pencil m-r-5"></i> Edit</a>
                                    <a className="dropdown-item" onClick={() => this.handleDeleteConfirm(itemCategoryList.banner_id)}><i className="fa fa-trash-o m-r-5"></i> Delete</a>
                                  </div>
                                </div>
                              </td>
                            </tr>
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <div className="form-group">
                                <label>Banner:</label>
                                <input type="file" className="form-control" id="banner_img" name="banner_img" onChange={this.onChangeBanner} required />
                            </div>
                          </div>
          ...
          <div id="edit_form" className="modal custom-modal fade" role="dialog">
            <div className="modal-dialog modal-dialog-centered modal-md">
                <div className="modal-content">
                    <div className="modal-header">
                        <h4 className="modal-title">Info Banner</h4>
                        <button type="button" className="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-12">
                            <div className="form-group">
                                ...
                                <input type="file" className="form-control" id="edit_banner_img" name="banner_img" onChange={this.onChangeEditBanner} required />
                            </div>
                          </div>
